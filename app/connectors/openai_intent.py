...
SYSTEM_PROMPT = (
    ...
    "with {title, date?, time?, notes?, location?, list_hint?}. The list_hint should extract "
    "any mention of a specific task list like 'groceries list', 'work tasks', etc. For 'update', fill 'task_update' with "
    "{criteria:{...}, changes:{...}}.\n"
